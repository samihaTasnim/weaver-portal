...
const rows = [
  createData('29/10/2021', '23', '23', '5', '5', 'Parag P', 'Parag P'),
  createData('29/10/2021', '24', '23', '5', '8', 'Deepak P', 'Parag P'),
  createData('29/10/2021', '24', '23', '5', '5', 'Ajay P', 'Parag P'),
  createData('29/10/2021', '24', '23', '5', '3', 'Parag P', 'Parag P'),
  createData('29/10/2021', '24', '23', '5', '7', 'Deepak R', 'Parag P'),
  createData('29/10/2021', '24', '23', '5', '8', 'Parag P', 'Parag P'),
];
        ...
        <Table className={classes.table} aria-label="customized table" size="medium">
          <TableHead>
            <TableRow>
              ...
              <StyledTableCell>Piece No. </StyledTableCell>
              <StyledTableCell>Average L2L</StyledTableCell>
